...
import { BookOpen, Users, Star, IndianRupee, Plus } from 'lucide-react';
import { fetchInstructorStats } from '../../store/slices/dashboardSlice';
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    {courseStats?.averageRating?.toFixed(1) || 0}
                  </dd>
                </dl>
              </div>
            </div>
                      ...
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10">
                          <img
                            ...
                            src="https://images.pexels.com/photos/5905710/pexels-photo-5905710.jpeg"
                            alt=""
                          />
                        </div>
                        <div className="ml-4">
